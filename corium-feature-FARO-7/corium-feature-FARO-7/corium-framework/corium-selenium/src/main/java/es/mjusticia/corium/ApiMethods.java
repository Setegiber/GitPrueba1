...
public class ApiMethods extends SeleniumMethods {
    ...
    public CookieManager defaultCookieManager = new CookieManager(null,CookiePolicy.ACCEPT_ALL);
    public CookieJar cookieJar = new OkHttp3CookieJar();
    public Cookie seleniumCookies;
    public static List<Cookie> seleniumCookiesList = new ArrayList<>();
    ...
    static {
        ...
        if (isPropertyNullOrEmpty(API_TRUSTSTORE_PATH_FILE)){
            if (isPropertyNullOrEmpty(API_TRUSTSTORE_PATH_FILE_PASSWORD)) {
    ...
    public static void apiConfiguration(){
        ...
        apiMethods.defaultCookieManager.setCookiePolicy(CookiePolicy.ACCEPT_ALL);
        try {
    ...
    public HttpClient defaultClientHttp_1_1Configuration(){
        return clientHttp_1_1 = HttpClient.newBuilder()
    ...
    public HttpClient defaultClientHttp2Configuration(){
        return clientHttp2 = HttpClient.newBuilder()
                .cookieHandler(defaultCookieManager)
    ...
    public OkHttpClient defaultClientOk2Configuration(){
        return clientOk2 = new OkHttpClient
                .Builder()
                .connectTimeout(getApiConnectTimeoutProperty(), TimeUnit.SECONDS)
                .readTimeout(getApiConnectTimeoutProperty(), TimeUnit.SECONDS)
                .hostnameVerifier((hostname,sslContext) -> true)
    ...
    public void clearCookiesInHttpClientCookieManager(){
        defaultCookieManager.getCookieStore().removeAll();
    }
    ...
    public static String getAuthenticationBasicToken(String usernameBasic, String passwordBasic){
        ...
        return "Basic " + new String(authEncode);
    }
    ...
    public String okGetRequestString(String uri){
        try {
            return okGetRequest(uri).body().string();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String okGetRequest1_1String(String uri){
        try {
            return okGetRequest1_1(uri).body().string();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String okGetRequestAuthorizationString(String usernameBasic, String passwordBasic, String uri){
        try {
            return okGetRequestAuthorization(usernameBasic,passwordBasic,uri).body().string();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String okPostRequestString(String uri, Map<String,String> postNamesValues){
        try {
            return okPostRequest(uri,postNamesValues).body().string();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String okPostRequestAuthorizationString(String usernameBasic, String passwordBasic, String uri, Map<String,String> postNamesValues){
        try {
            return okPostRequestAuthorization(usernameBasic,passwordBasic,uri,postNamesValues).body().string();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    private void configureTrustStore(String truststorePathFile, String truststorePathFilePassword) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException, KeyManagementException {
        ...
        FileInputStream file = new FileInputStream(truststorePathFile);
    ...
    private void configureCertificateKey(String certificateFileP12, String certificateFileP12Password) throws KeyStoreException, IOException, NoSuchAlgorithmException, CertificateException, UnrecoverableKeyException, KeyManagementException {
        KeyStore keystore = KeyStore.getInstance("PKCS12");
        keystore.load(new FileInputStream(certificateFileP12), certificateFileP12Password.toCharArray());
    ...
    private void saveCookiesOkHttpSelenium(String uri){
        ...
        seleniumCookiesList.clear();
        for (okhttp3.Cookie cookie : cookiesOkHttp){
            seleniumCookies = new Cookie(cookie.name(),cookie.value());
            seleniumCookiesList.add(seleniumCookies);
            ...
            defaultCookieManager.getCookieStore().add(null,cookieJava11);
        }
    }
    ...
    private void saveCookiesHttpSelenium(String uri){
        List <HttpCookie> cookiesJava11 = defaultCookieManager.getCookieStore().getCookies();
        ...
        for (HttpCookie javaCookie : cookiesJava11){
            seleniumCookies = new Cookie(javaCookie.getName(),javaCookie.getValue());
            seleniumCookiesList.add(seleniumCookies);
        ...
        cookieJar.saveFromResponse(HttpUrl.get(uri),okCookieList);
    }
