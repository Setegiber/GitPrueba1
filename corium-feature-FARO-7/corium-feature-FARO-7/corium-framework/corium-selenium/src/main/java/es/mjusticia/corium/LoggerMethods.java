...
public class LoggerMethods extends FrameworkPaths {
    ...
    private static final String
            ...
            getDefaultLoggerAuthorDevice = "default-author";

    private String
            loggerEnvironmentExecutionProperty = null,
            loggerAuthorDeviceProperty = null;

    private String getLoggerAuthorDeviceProperty(){
        return getProperty(
                loggerAuthorDeviceProperty,
    ...
    public void startLoggerConfigurationConfig(Method method) {
        ...
        test.log(Status.INFO, MarkupHelper.createLabel(LABEL_MESSAGE_START, ExtentColor.BLUE));
    ...
    private static void loggerExtent(Status statusTest, String testMessage) {
        test.log(statusTest, testMessage,null);
    }
    ...
    private static void loggerExtent(Status statusTest, String testMessage, String screenshotName) {
        try{
            if (screenshotName != null) {
                test.log(statusTest, testMessage, MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotName).build());
            } else {
                test.log(statusTest, testMessage);
            }
    ...
    private static void loggerExtentLabel(Status statusTest, String testMessage, ExtentColor colorType) {
        test.log(statusTest, MarkupHelper.createLabel(testMessage.toUpperCase(Locale.ROOT), colorType));
    }
}
