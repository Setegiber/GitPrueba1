...
public class SeleniumMethods extends SeleniumConfig {
    ...
    public String getCurrentUrl() {
        return getCurrentUrl(webDriver);
    }
    ...
    public void navigateForwardBack(Integer forwardBackNumber) {
        ((JavascriptExecutor) webDriver).executeScript("window.history.go(" + forwardBackNumber.toString() + ")");
        pause(1);
    ...
    public Set<Cookie> getCookiesWebdriver() {
        return getCookiesWebdriver(webDriver);
    }
    ...
    public String getCookieWebdriverByName(String cookieName) {
        return getCookieWebdriverByName(cookieName, webDriver);
    }
    ...
    public void deleteCookiesWebdriver() {
        deleteCookiesWebdriver(webDriver);
    }
    ...
    public void addCookiesWebdriver(List<Cookie> addCookie) {
        addCookiesWebdriver(addCookie, webDriver);
    }
    ...
    public static void addCookiesWebdriver(Set<Cookie> cookies) {
        addCookiesWebdriver(cookies, webDriver);
    }
    ...
    public static Wait fluentWait(int timerOfSeconds) {
        return fluentWait(timerOfSeconds, webDriver);
    }
    ...
    public boolean waitUntilUrlContains(String expectedUrl) {
        return waitUntilUrlContains(expectedUrl, webDriver);
    }
    ...
    public boolean waitUntilUrlContains(String expectedUrl, int seconds) {
        return waitUntilUrlContains(expectedUrl, seconds, webDriver);
    }
    ...
    public boolean waitUntilElementIsClickedInterceptedCss(By elementToBeClicked) {
        return waitUntilElementIsClickedInterceptedCss(elementToBeClicked, IMPLICIT_WAIT, 0);
    }
    ...
    public void waitUntilElementIsClickedThenUntilDisplayed(By elementToBeClicked, By elementToBeDisplayed) {
        waitUntilElementIsClickedThenUntilDisplayed(elementToBeClicked, elementToBeDisplayed, 0, 0, IMPLICIT_WAIT);
    }
    ...
    public void waitUntilElementIsClickedThenUntilDisplayed(By elementToBeClicked, By elementToBeDisplayed, int elementToBeClickedIndex) {
        waitUntilElementIsClickedThenUntilDisplayed(elementToBeClicked, elementToBeDisplayed, elementToBeClickedIndex, 0, IMPLICIT_WAIT);
    }
    ...
    public void waitUntilElementIsClickedThenUntilDisplayed(By elementToBeClicked, By elementToBeDisplayed, int elementToBeClickedIndex, int elementToBeDisplayedIndex) {
        waitUntilElementIsClickedThenUntilDisplayed(elementToBeClicked, elementToBeDisplayed, elementToBeClickedIndex, elementToBeDisplayedIndex, IMPLICIT_WAIT);
    }
    ...
    public void clickElementAndWaitForWebElementCondition(By initialClick, By locatorToWaitFor, Function<WebElement, Boolean> webElementCondition) {
        clickElementAndWaitForWebElementCondition(initialClick, locatorToWaitFor, webElementCondition, IMPLICIT_WAIT, IMPLICIT_WAIT, 0, 0);
    }
    ...
    public void clickElementAndWaitForWebElementCondition(By initialClick, By locatorToWaitFor, Function<WebElement, Boolean> webElementCondition, int waitTimePageElementsLoad) {
        clickElementAndWaitForWebElementCondition(initialClick, locatorToWaitFor, webElementCondition, waitTimePageElementsLoad, IMPLICIT_WAIT, 0, 0);
    }
    ...
    public void turnOnImplicitWaits() {
        ...
        loggerSlf4jInfo("Selenium, implicit waits default on: " + IMPLICIT_WAIT + "s");
    }
    ...
    public void turnOnImplicitWaitsVariable(int howMuchTime) {
        IMPLICIT_WAIT = howMuchTime;
        webDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(howMuchTime));
        loggerSlf4jInfo("Selenium, new implicit waits on: " + IMPLICIT_WAIT + "s");
    }
    ...
    public void turnOnImplicitWaitsNoChange(int howMuchTime) {
        webDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(howMuchTime));
        loggerSlf4jInfo("Selenium, implicit waits on with parameter: " + IMPLICIT_WAIT + "s");
    }
    ...
    public void waitForPageToLoad(int waitTime) {
        waitForPageToLoad(waitTime, webDriver);
    }
    ...
    public boolean waitForNumberOfWindows(int expectedNumberOfWindows, int timeoutInSeconds) {
        for (int i = 0; i < timeoutInSeconds; i++) {
            if (webDriver.getWindowHandles().size() >= expectedNumberOfWindows) {
                waitForPageToLoad();
        ...
        loggerSlf4jInfo("Selenium, timeout waiting for windows. Current count: " + webDriver.getWindowHandles().size());
        return false;
    }
    ...
    public void switchToTab(int tabIndex) {
        ...
        if (tabIndex >= 0 && tabIndex < windowHandles.size()) {
            ...
            webDriver.switchTo().window(handlesList.get(tabIndex));
    ...
    public void switchToTabContainsUrl(String tabUrl) {
        for (int i = 0; i <= webDriver.getWindowHandles().size(); i++) {
    ...
    public void waitTabToLoad(int timeWait) {
        WebDriverWait wait = new WebDriverWait(webDriver, Duration.ofSeconds(timeWait));
    ...
    public void mouseOverSubMenu(WebElement fatherMenu, String subMenu) {
        Actions actionsChild = new Actions(webDriver);
        Actions actionsFather = new Actions(webDriver);
    ...
    public void javaExecutorUploadHidden(WebElement elementUploadHidden, String absolutePath) {
        JavascriptExecutor executeDriver = (JavascriptExecutor) webDriver;
    ...
    public void scrollUp(String parsePosition) {
        JavascriptExecutor jseScrollUp = (JavascriptExecutor) webDriver;
    ...
    public String screenshotFullscreen(String imageName) {
        ...
        if (getSeleniumBrowserDriverProperty().startsWith("firefox")) {
            src = ((FirefoxDriver) webDriver).getFullPageScreenshotAs(OutputType.FILE);
        } else if (getSeleniumBrowserDriverProperty().startsWith("chrome")) {
            src = ((ChromeDriver) webDriver).getScreenshotAs(OutputType.FILE);
        } else if (getSeleniumBrowserDriverProperty().startsWith("edge")) {
            src = ((EdgeDriver) webDriver).getScreenshotAs(OutputType.FILE);
        }
        try {
