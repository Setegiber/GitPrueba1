...
@Component
public class ResolucionEstimatoriaParcialClasificacion implements EvaluadorClasificacion {
  ...
  public boolean cumpleClasificacion(BigInteger idExp) throws SinacException {
    ...
    return sentidoResolucion.getCodLdvMae().equals("RES-ESP") || sentidoResolucion.getCodLdvMae().equals("SEN-ESP");
  }
