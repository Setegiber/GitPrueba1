...
@Component
public class ResolucionEstimatoriaPorDesistimientoDesaparicionClasificacion implements EvaluadorClasificacion {
  ...
  public boolean cumpleClasificacion(BigInteger idExp) throws SinacException {
    ...
    return sentidoResolucion.getCodLdvMae().equals("RES-EDD");
  }
