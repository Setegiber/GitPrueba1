...
@Component
public class ResolucionEstimatoriaOEstimatoriaParicalClasificacion implements EvaluadorClasificacion {
  ...
  public boolean cumpleClasificacion(BigInteger idExp) throws SinacException {
    ...
    return sentidoResolucion != null && (sentidoResolucion.getCodLdvMae().equals("RES-EST")
        || sentidoResolucion.getCodLdvMae().equals("RES-ESP") || sentidoResolucion.getCodLdvMae().equals("SEN-ESP")
        || sentidoResolucion.getCodLdvMae().equals("SEN-EST"));
  }
