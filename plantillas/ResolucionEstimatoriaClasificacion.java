...
@Component
public class ResolucionEstimatoriaClasificacion implements EvaluadorClasificacion {
  ...
  public boolean cumpleClasificacion(BigInteger idExp) throws SinacException {
    ...
    return sentidoResolucion.getCodLdvMae().equals("RES-EST") || sentidoResolucion.getCodLdvMae().equals("SEN-EST");
  }
