...
@Component
public class InterposicionResidenciaClasificacion implements EvaluadorClasificacion {

  @Autowired
  ExpedienteFormularioValDao expForValDao;
  @Autowired
  ExpedienteFormularioValMapper expForValMapper;

  @Override
  public boolean cumpleClasificacion(BigInteger idExp) throws SinacException {
    ExpedienteFormularioValDto expForValDto = expForValMapper
        .toDto(expForValDao.getExpFormByIdExpCodCampo(idExp, "PEORI"));

    return expForValDto.getValor().equals("R");
  }
