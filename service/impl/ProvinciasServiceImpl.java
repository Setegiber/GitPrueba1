...
public class ProvinciasServiceImpl implements ProvinciasService {
  ...
  @Autowired
  ProvinciasMapper provinciasMapper;
  
  @Override
  public ProvinciasDto getProvinciaByCodProv(String codProv) {
    return provinciasMapper.toDto(provinciasDao.getProvinciaByCodProv(codProv));
  }
