...
public class TipoViaServiceImpl implements TipoViaService {
  @Autowired
  TiposViaDao tipoViaDao;
  
  @Autowired
  TiposViaMapper tipoViaMapper;

  @Override
  public TiposViaDto getTipoViaPorCodDgp(String codDgp) {
    return tipoViaMapper.toDto(tipoViaDao.getTipoViaByCodDgp(codDgp));
  }
