...
public class SeleniumConfig extends FrameworkMethods {
    ...
    private String seleniumStartProperty = null;
    private String seleniumStartMobileProperty = null;
    private String seleniumHeadlessDriverProperty = null;
    private String seleniumBrowserDriverProperty = null;
    private String seleniumDisableDevtoolsProperty = null;
    private String seleniumScreenshotOnFinishProperty = null;
    private String seleniumProxyOnProperty = null;
    private String seleniumFirefoxProxyTypeProperty = null;
    private String seleniumFirefoxSetBinaryProperty = null;
    private String seleniumProxyHostProperty = null;
    private String seleniumProxyPortProperty = null;
    private String seleniumProxyNoProxyForProperty = null;
...
//        }
    ...
    public void setupSelenium() {
        setWebDriver(setupSelenium(getWebDriver()));
    }
    ...
    private void setupSeleniumDimensions(WebDriver webDriverManual) {
        ...
        webDriverManual.manage()
                .timeouts()
                .implicitlyWait(Duration.ofSeconds(getIMPLICIT_WAIT()));
    }
...
//        System.setProperty("webdriver.chrome.verboseLogging", "true");
    ...
    private void webdriverCloseValidation(WebDriver webDriverManual) {
    	if (webDriverManual == null) {
    	    ...
    	    try {
    	        ...
    	        loggerSlf4jInfo("Warning - Failed to quit WebDriver: " + e.getMessage());
    	    }
    	}
    }
	...
	public static void setWebDriver(WebDriver webDriver) {
		SeleniumConfig.webDriver = webDriver;
	}

	public static int getIMPLICIT_WAIT() {
		return IMPLICIT_WAIT;
	}

	public static void setIMPLICIT_WAIT(int iMPLICIT_WAIT) {
