...
public class FrameworkJenkins extends FrameworkMethods {
    ...
    private static String jenkinsHostProperty = null;
    private static String jenkinsUsernameProperty = null;
    private static String jenkinsPasswordProperty = null;
     ...
     */
    public static String getJenkinsHostProperty() {
        return getProperty(
                jenkinsHostProperty,
                JENKINS_HOST,
                getDefaultJenkinsHost);
     ...
     */
    public static void setJenkinsHostProperty(String keyValue) {
     ...
     */
    public static String getJenkinsUsernameProperty() {
        return getProperty(
     ...
     */
    public static void setJenkinsUsernameProperty(String keyValue) {
     ...
     */
    public static String getJenkinsPasswordProperty() {
        return getProperty(
     ...
     */
    public static void setJenkinsPasswordProperty(String keyValue) {
    ...
    private void executeJobPost(String username, String password, String hostName, String jobName, Map<String, String> postKeyValues) {
        ...
        try {
            Response response = apiMethods.okRequest(apiMethods.defaultClientOk2Configuration(),
